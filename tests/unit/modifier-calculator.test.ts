...
describe('calculateStructureModifiers', () => {
  ...
  it('should calculate Farm modifiers at level 1', () => {
    ...
    const foodMod = modifiers.find(m => m.type === 'FOOD_PRODUCTION');
  ...
  it('should calculate Workshop modifiers with EXPONENTIAL scaling', () => {
    ...
    const upgradeMod = modifiers.find(m => m.type === 'UPGRADE_SPEED');
    ...
    const upgradeModL5 = modifiersL5.find(m => m.type === 'UPGRADE_SPEED');
